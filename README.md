...
```
100000 elements
  Set                                      13.313 ms (38 allocations: 7.50 MiB)
  DataStructures.SortedSet                 87.668 ms (91 allocations: 24.57 MiB)
  DataStructures.AVLTree                   4.264 s (7102520 allocations: 114.48 MiB)
  DataStructures.RBTree                    372.236 ms (200003 allocations: 12.21 MiB)
  AVLTrees.AVLSet                          23.564 ms (200002 allocations: 9.16 MiB)
  Tree without allocator                   47.121 ms (200001 allocations: 9.16 MiB)
  with fixed allocator                     60.130 ms (1 allocation: 16 bytes)
  with resizable allocator                 62.703 ms (1 allocation: 16 bytes)
  with fixed free list allocator           57.926 ms (1 allocation: 16 bytes)
  with resizable free list allocator       58.187 ms (1 allocation: 16 bytes)
  with fixed SOA allocator                 117.164 ms (1 allocation: 16 bytes)
  with resizable SOA allocator             128.036 ms (1 allocation: 16 bytes)
  with fixed free list SOA allocator       124.914 ms (1 allocation: 16 bytes)
  with resizable free list SOA allocator   117.649 ms (1 allocation: 16 bytes)
1000 elements
  Set                                      113.400 μs (18 allocations: 49.58 KiB)
  DataStructures.SortedSet                 346.400 μs (56 allocations: 322.94 KiB)
  DataStructures.AVLTree                   23.976 ms (28637 allocations: 509.97 KiB)
  DataStructures.RBTree                    2.921 ms (2003 allocations: 125.11 KiB)
  AVLTrees.AVLSet                          179.500 μs (2002 allocations: 93.78 KiB)
  Tree without allocator                   366.500 μs (2001 allocations: 93.77 KiB)
  with fixed allocator                     360.200 μs (1 allocation: 16 bytes)
  with resizable allocator                 358.500 μs (1 allocation: 16 bytes)
  with fixed free list allocator           396.700 μs (1 allocation: 16 bytes)
  with resizable free list allocator       396.200 μs (1 allocation: 16 bytes)
  with fixed SOA allocator                 727.600 μs (1 allocation: 16 bytes)
  with resizable SOA allocator             718.300 μs (1 allocation: 16 bytes)
  with fixed free list SOA allocator       785.200 μs (1 allocation: 16 bytes)
  with resizable free list SOA allocator   778.300 μs (1 allocation: 16 bytes)
10 elements
  Set                                      601.130 ns (8 allocations: 1.33 KiB)
  DataStructures.SortedSet                 2.167 μs (28 allocations: 5.75 KiB)
  DataStructures.AVLTree                   91.500 μs (102 allocations: 2.23 KiB)
  DataStructures.RBTree                    31.300 μs (23 allocations: 1.36 KiB)
  AVLTrees.AVLSet                          1.790 μs (22 allocations: 992 bytes)
  Tree without allocator                   1.870 μs (21 allocations: 976 bytes)
  with fixed allocator                     1.520 μs (1 allocation: 16 bytes)
  with resizable allocator                 1.520 μs (1 allocation: 16 bytes)
  with fixed free list allocator           1.800 μs (1 allocation: 16 bytes)
  with resizable free list allocator       1.760 μs (1 allocation: 16 bytes)
  with fixed SOA allocator                 3.971 μs (1 allocation: 16 bytes)
  with resizable SOA allocator             3.938 μs (1 allocation: 16 bytes)
  with fixed free list SOA allocator       4.414 μs (1 allocation: 16 bytes)
  with resizable free list SOA allocator   5.057 μs (1 allocation: 16 bytes)
```
