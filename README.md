...
```
10 runs with 100000 elements
  DataStructures.AVLTree                   39.386 s (71025181 allocations: 1.12 GiB)
  DataStructures.RBTree                    3.322 s (2000002 allocations: 122.07 MiB)
  AVLTrees.AVLSet                          1.855 s (2000001 allocations: 91.55 MiB)
  Tree without allocator                   1.102 s (2000000 allocations: 91.55 MiB)
  with fixed allocator                     796.645 ms (0 allocations: 0 bytes)
  with resizable allocator                 829.744 ms (0 allocations: 0 bytes)
  with fixed free list allocator           744.617 ms (0 allocations: 0 bytes)
  with resizable free list allocator       748.283 ms (0 allocations: 0 bytes)
  with fixed SOA allocator                 915.186 ms (0 allocations: 0 bytes)
  with resizable SOA allocator             882.819 ms (0 allocations: 0 bytes)
  with fixed free list SOA allocator       916.841 ms (0 allocations: 0 bytes)
  with resizable free list SOA allocator   911.279 ms (0 allocations: 0 bytes)
1000 runs with 1000 elements
  DataStructures.AVLTree                   24.614 s (28635001 allocations: 497.97 MiB)
  DataStructures.RBTree                    2.816 s (2000002 allocations: 122.07 MiB)
  AVLTrees.AVLSet                          1.752 s (2000001 allocations: 91.55 MiB)
  Tree without allocator                   693.442 ms (2000000 allocations: 91.55 MiB)
  with fixed allocator                     323.711 ms (0 allocations: 0 bytes)
  with resizable allocator                 318.323 ms (0 allocations: 0 bytes)
  with fixed free list allocator           317.841 ms (0 allocations: 0 bytes)
  with resizable free list allocator       321.046 ms (0 allocations: 0 bytes)
  with fixed SOA allocator                 470.781 ms (0 allocations: 0 bytes)
  with resizable SOA allocator             462.786 ms (0 allocations: 0 bytes)
  with fixed free list SOA allocator       489.916 ms (0 allocations: 0 bytes)
  with resizable free list SOA allocator   492.005 ms (0 allocations: 0 bytes)
100000 runs with 10 elements
  DataStructures.AVLTree                   9.334 s (10000001 allocations: 213.62 MiB)
  DataStructures.RBTree                    2.388 s (2000002 allocations: 122.07 MiB)
  AVLTrees.AVLSet                          1.667 s (2000001 allocations: 91.55 MiB)
  Tree without allocator                   350.237 ms (2000000 allocations: 91.55 MiB)
  with fixed allocator                     114.365 ms (0 allocations: 0 bytes)
  with resizable allocator                 101.773 ms (0 allocations: 0 bytes)
  with fixed free list allocator           104.650 ms (0 allocations: 0 bytes)
  with resizable free list allocator       104.811 ms (0 allocations: 0 bytes)
  with fixed SOA allocator                 168.423 ms (0 allocations: 0 bytes)
  with resizable SOA allocator             170.083 ms (0 allocations: 0 bytes)
  with fixed free list SOA allocator       185.740 ms (0 allocations: 0 bytes)
  with resizable free list SOA allocator   183.313 ms (0 allocations: 0 bytes)
```
